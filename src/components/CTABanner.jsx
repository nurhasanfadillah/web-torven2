  ...
  return (
    <section ref={ref} className="py-20 px-4 sm:px-6 lg:px-8 relative">
      ...
      <motion.div
        ...
        className="absolute top-8 left-8 w-16 h-16 rounded-2xl glass flex items-center justify-center"
      >
      ...
      <motion.div
        ...
        className="absolute bottom-8 right-8 w-16 h-16 rounded-2xl glass flex items-center justify-center"
      >
